(function(P, M) {
    "object" === typeof module && module.exports ? (M["default"] = M, module.exports = P.document ? M(P) : M) : "function" === typeof define && define.amd ? define("Mychart/Mychart", function() {
        return M(P)
    }) : (P.Mychart && P.Mychart.error(16, !0), P.Mychart = M(P))
    ...
    M(I, "parts/Utilities.js", [I["parts/Globals.js"]], function(c) {
        ...
        c.error = function(a, d, e, l) {
            var g = v(a),
                h = g ? "Mychart error #" + a + ": www.Mychart.com/errors/" + a + "/" : a.toString(),
                p = function() {
                    if (d) throw Error(h);
        ...
        c.Fx.prototype = {
            ...
            run: function(a, d, e) {
                ...
                a !== d || this.elem["forceAnimate:" + this.prop] ?
            ...
            initPath: function(a, d, e) {
                ...
                function g(a, d) {
                    for (; a.length < h;) {
                        ...
                        w && (e = a.slice(a.length - r), [].splice.apply(a, [a.length, 0].concat(e)),
                            A--)
                    }
                    a[0] = "M"
                }
        ...
        c.merge = function() {
            ...
            !0 === d[0] &&
                (e = d[1], d = Array.prototype.slice.call(d, 2));
            var g = d.length;
        ...
        c.normalizeTickInterval = function(a, d, e, b, g) {
            ...
            for (b = 0; b < d.length && !(l = d[b], g && l * e >= a || !g && p <= (d[b] +
                    (d[b + 1] || d[b])) / 2); b++);
        ...
        c.getStyle = function(a, d, e) {
            ...
            if ("height" === d) return Math.max(0,
                Math.min(a.offsetHeight, a.scrollHeight) - c.getStyle(a, "padding-top") - c.getStyle(a, "padding-bottom"));
        ...
        c.removeEvent = function(a, b, e) {
            ...
            function g(e) {
                ...
                if (a.nodeName) {
                    ...
                    n(k, function(a, b) {
                        if (e[b])
                            for (l = e[b].length; l--;) d(b, e[b][l].fn)
                    })
                }
            }
            var h;
        ...
        b.jQuery && (b.jQuery.fn.Mychart = function() {
            var a = [].slice.call(arguments);
            if (this[0]) return a[0] ?
                (new(c[F(a[0]) ? a.shift() : "Chart"])(this[0], a[0], a[1]), this) : q[H(this[0], "data-Mychart-chart")]
        });
        return {
            arrayMax: function(a) {
        ...
        c.Color.prototype = {
            ...
            brighten: function(c) {
                ...
                if (this.stops) this.stops.forEach(function(f) {
                    ...
                    for (f = 0; 3 > f; f++) v[f] += G(255 * c), 0 > v[f] && (v[f] = 0), 255 < v[f] && (v[f] = 255);
                return this
            },
    ...
    M(I, "parts/SvgRenderer.js", [I["parts/Globals.js"], I["parts/Utilities.js"]], function(c, f) {
        ...
        t(O.prototype, {
                ...
                c.fireEvent(this.renderer,
                    ...
                    function() {
                        ...
                        e && (w = a[e], k = D.gradients, g = a.stops, p = d.radialReference, v(w) && (a[e] = w = {
                            ...
                            J.push(a)
                        }), J = J.join(","), k[J] ? K = k[J].attr("id") : (w.id = K = c.uniqueKey(), k[J] = l =
                            D.createElement(e).attr(w).add(D.defs), l.radAttr = N, l.stops = [], g.forEach(function(a) {
            ...
            removeTextOutline: function(a) {
                for (var b = a.length, D; b--;) D = a[b], "Mychart-text-outline" === D.getAttribute("class") && B(a, this.element.removeChild(D))
            },
            ...
            attr: function(a, b, d, e) {
                ...
                "string" === typeof a ? w = (this[a + "Getter"] || this._defaultGetter).call(this,
                    a, D) : (h(a, function(b, d) {
                    N = !1;
                    e || K(this, d);
            ...
            getBBox: function(a, b) {
                ...
                if (!d) {
                    if (g || e.forExport) {
                        try {
                            (k = this.fakeTS && function(a) {
                                [].forEach.call(m.querySelectorAll(".Mychart-text-outline"), function(b) {
                                    b.style.display = a
                                })
                    ...
                    e.isSVG && (a = d.width, e = d.height, g && (d.height = e = {
                        "11px,17": 14,
                        "13px,20": 16
                    }[D && D.fontSize + "," + Math.round(e)] || e), b && (D = b * E, d.width = Math.abs(e * Math.sin(D)) + Math.abs(a * Math.cos(D)),
                        d.height = Math.abs(e * Math.cos(D)) + Math.abs(a * Math.sin(D))));
                    if (c && 0 < d.height) {
            ...
            shadow: function(a,
                ...
                if (!a) this.destroyShadows();
                    ...
                    for (m = 1; m <= D; m++) {
                        ...
                        g.setAttribute("class", (g.getAttribute("class") || "") + " Mychart-shadow");
            ...
            titleSetter: function(a) {
                ...
                b.appendChild(p.createTextNode(String(n(a,
            ...
            setTextPath: function(a, b) {
                ...
                if (a && b && b.enabled) {
                    ...
                    G(l.dx) && (g.parentNode.setAttribute("dx", l.dx),
                        delete l.dx);
                    h(l, function(a, b) {
            ...
            zIndexSetter: function(a, b) {
                ...
                var D = this.added;
                var l;
                G(a) ? (w.setAttribute("data-z-index", a), a = +a, this[b] === a && (D = !1)) : G(this[b]) &&
                ...
                if (D) {
                    ...
                    for (l = b.length - 1; 0 <= l && !k; l--) {
                        ...
                        var g = !G(D);
                        if (e !== w)
                            if (0 > a && g && !d && !l) m.insertBefore(w, b[l]), k = !0;
                            else if (q(D) <= a || g && (!G(a) || 0 <= a)) m.insertBefore(w, b[l + 1] || null), k = !0
                    }
        ...
        O.prototype["stroke-widthSetter"] = O.prototype.strokeSetter = function(a, b, d) {
            this[b] = a;
            this.stroke && this["stroke-width"] ? (O.prototype.fillSetter.call(this, this.stroke, "stroke", d), d.setAttribute("stroke-width", this["stroke-width"]), this.hasStroke = !0) : "stroke-width" ===
        ...
        t(f.prototype, {
            ...
            init: function(a, d, e, m, w, g, r) {
                ...
                F(a, "dir", "ltr"); - 1 === a.innerHTML.indexOf("xmlns") &&
                    F(m, "xmlns", this.SVG_NS);
                this.isSVG = !0;
                this.box = m;
                this.boxWrapper = D;
                this.alignedObjects = [];
                this.url = (k || x) && p.getElementsByTagName("base").length ? Q.location.href.split("#")[0].replace(/<[^>]*>/g, "").replace(/([\('\)])/g, "\\$1").replace(/ /g, "%20") : "";
                this.createElement("desc").add().element.appendChild(p.createTextNode("Created with Mychart 7.2.1"));
            ...
            buildText: function(a) {
                ...
                if (t !== a.textCache) {
                    ...
                    w || K || A || c || -1 !== m.indexOf(" ") && (!u || Q.test(m)) ? (r && r.appendChild(b), w ? (m = d.styledMode ? m.replace(/<(b|strong)>/g, '<span class="Mychart-strong">').replace(/<(i|em)>/g, '<span class="Mychart-emphasized">') :
                        m.replace(/<(b|strong)>/g, '<span style="font-weight:bold">').replace(/<(i|em)>/g, '<span style="font-style:italic">'), m = m.replace(/<a/g, "<span").replace(/<\/(b|strong|i|em|a)>/g, "</span>").split(Q)) : m = [m], m = m.filter(function(a) {
                        return "" !== a
                        ...
                        x.forEach(function(m) {
                            if ("" !== m || 1 === x.length) {
                                ...
                                (n = O(m, "href")) && !e && (F(N, "onclick", 'location.href="' + n + '"'), F(N, "class", "Mychart-anchor"), d.styledMode || l(N, {
                                    cursor: "pointer"
                                }));
                                ...
                                if (" " !== m) {
                                    ...
                                    if (c) {
                                        ...
                                        if (A) D = d.truncate(a, N, m, void 0, 0, Math.max(0, c - parseInt(L || 12, 10)), function(a, b) {
                                            ...
                                            for (; T.length;) T.length && !u && 0 < n && (N = p.createElementNS(U, "tspan"), F(N, {
                                                dy: f,
                                                x: g
            ...
            button: function(a, d, m, e, w, k, l, g, c, x) {
                ...
                D.setState = function(a) {
                    1 !== a && (D.state = p = a);
                    D.removeClass(/Mychart-button-(normal|hover|pressed|disabled)/).addClass("Mychart-button-" + ["normal", "hover", "pressed", "disabled"][a || 0]);
            ...
            symbols: {
                ...
                arc: function(a, b, d, m, e) {
                    ...
                    G(d) && e.push(m ? "M" : "L", a + d * x, b + d * g, "A", d,
                        d, 0, w, 0, a + d * r, b + d * c);
                    e.push(m ? "" : "Z");
                    return e
                },
                callout: function(a, b, d, m, e) {
                    ...
                    l && l > d ? e > b + k && e < b + m - k ? g.splice(13, 3, "L", a + d, e - 6, a + d + 6, e, a + d, e + 6, a + d, b + m - w) : g.splice(13, 3, "L", a + d, m / 2, l, e, a + d, m / 2, a + d, b + m - w) : l && 0 > l ? e > b + k && e < b + m - k ? g.splice(33, 3, "L", a, e + 6, a - 6, e, a, e - 6, a, b + w) : g.splice(33,
                        3, "L", a, m / 2, l, e, a, m / 2, a, b + w) : e && e > m && l > a + k && l < a + d - k ? g.splice(23, 3, "L", l + 6, b + m, l, b + m + 6, l - 6, b + m, a + w, b + m) : e && 0 > e && l > a + k && l < a + d - k && g.splice(3, 3, "L", l - 6, b, l, b - 6, l + 6, b, d - w, b);
                    return g
                }
            },
            ...
            label: function(a, b, d, e, w, k, l, g, r) {
                ...
                r && J.addClass("Mychart-" + r);
                var R = function() {
                    var a = p.element.style,
                        b = {};
                    h = (void 0 === n || void 0 === N || f) &&
                        G(p.textStr) && p.getBBox();
                    J.width = (n || h.width || 0) + 2 * u + L;
                    J.height = (N || h.height || 0) + 2 * u;
                    S = u + Math.min(c.fontMetrics(a && a.fontSize, p).b, h ? h.height : Infinity);
                    Q && (K || (J.box = K = c.symbols[e] || v ? c.symbol(e) : c.rect(), K.addClass(("button" === r ? "" : "Mychart-label-box") + (r ? " Mychart-" + r + "-box" : "")), K.add(J), a = y(), b.x = a, b.y = (g ? -S : 0) + a), b.width = Math.round(J.width), b.height = Math.round(J.height), K.attr(t(b, q)), q = {})
                };
                var B = function() {
                    var a = L + u;
                    var b = g ? 0 : S;
                ...
                if (this.added) {
                    ...
                    if ("SPAN" === b.tagName) {
                        ...
                        var k = this.textWidth && t(this.textWidth),
                            ...
                            x;
                        (x = k !== this.oldTextWidth) && !(x = k > this.oldTextWidth) &&
                        ((x = this.textPxLength) || (C(b, {
                            width: "",
                            whiteSpace: u || "nowrap"
                        ...
                        r !== this.cTT && (u = g.fontMetrics(b.style.fontSize, b).b, !G(p) || p === (this.oldRotation || 0) && c === this.oldAlign || this.setSpanRotation(p, h, u), this.getSpanCorrection(!G(p) && this.textPxLength || b.offsetWidth,
                            u, h, p, c));
                        C(b, {
    ...
    M(I, "parts/Time.js", [I["parts/Globals.js"], I["parts/Utilities.js"]], function(c, f) {
        ...
        c.Time.prototype = {
            ...
            timezoneOffsetFunction: function() {
                ...
                return this.useUTC &&
                    n.getTimezoneOffset ? function(g) {
            ...
            getTimeTicks: function(c, n, f, g) {
                ...
                if (F(n)) {
                    ...
                    if (l >= H.month) {
                        b.set("Month", e, l >=
                            H.year ? 0 : h * Math.floor(b.get("Month", e) / h));
                    ...
                    n = e.getTime();
                    for (e = 1; n < f;) a.push(n), n = l === H.year ? b.makeTime(p + e * h, 0) : l === H.month ? b.makeTime(p, g + e * h) : !E || l !== H.day && l !== H.week ? E && l ===
                        H.hour && 1 < h ? b.makeTime(p, g, u, k + e * h) : n + l * h : b.makeTime(p, g, u + e * h * (l === H.day ? 1 : 7)), e++;
                    a.push(n);
        ...
        c.Tick.prototype = {
            ...
            handleOverflow: function(c) {
                ...
                var e = this.label,
                    ...
                    r, x = {};
                if (l || "justify" !==
                    t(f.overflow, "justify")) 0 > l && g - L * E < d ? r = Math.round(g / Math.cos(l * y) - d) : 0 < l && g + L * E > a && (r = Math.round((b - g) / Math.cos(l * y)));
            ...
            renderGridLine: function(c, n, f) {
                var g = this.axis,
                    ...
                    k = b[p + "LineColor"];
                b = b[p + "LineDashStyle"];
                a || (g.chart.styledMode || (d.stroke = k, d["stroke-width"] = u, b && (d.dashstyle = b)), l || (d.zIndex = 1), c && (n = 0), this.gridLine = a = E.path().attr(d).addClass("Mychart-" + (l ? l + "-" : "") + "grid-line").add(g.gridGroup));
            ...
            renderMark: function(c, n, f) {
                ...
                b = b[e + "Color"];
                l && (g.opposite && (l[0] = -l[0]), E && (this.mark = h = a.path().addClass("Mychart-" + (d ? d + "-" : "") + "tick").add(g.axisGroup), g.chart.styledMode || h.attr({
                        stroke: b,
                        "stroke-width": u
                    })),
                    h[E ? "attr" : "animate"]({
            ...
            renderLabel: function(c, n, f, g) {
                ...
                var E = !0,
                    p = c.x;
                c = c.y;
                e && B(p) && (e.xy = c = this.getLabelPosition(p, c, e, a, l, b, g, h), this.isFirst && !this.isLast && !t(d.showFirstLabel, 1) || this.isLast && !this.isFirst && !t(d.showLastLabel, 1) ? E = !1 : !a || l.step || l.rotation || n || 0 === f || this.handleOverflow(c), h && g % h && (E = !1), E && B(c.y) ?
    ...
    M(I, "parts/Axis.js", [I["parts/Globals.js"], I["parts/Utilities.js"]], function(c, f) {
        ...
        t(f.prototype, {
            ...
            init: function(a, b) {
                ...
                b = m.options.events; - 1 === a.axes.indexOf(m) && (d ? a.axes.splice(a.xAxis.length, 0, m) :
            ...
            defaultLabelFormatter: function() {
                ...
                if (p) var h = E(p, this, d);
                    ...
                    for (; x-- && void 0 === h;) d = Math.pow(g, x + 1), a >= d && 0 === 10 * b % d && null !== r[x] && 0 !== b && (h = c.numberFormat(b /
                        d, -1) + r[x]);
            ...
            getMinorTickPositions: function() {
                ...
                var g = c - l;
                if (g && g / e < a.len / 3)
                    if (a.isLog) this.paddedTicks.forEach(function(b, d, m) {
                    ...
                    for (b = l + (d[0] - l) % e; b <= c && b !== k[0]; b += e) k.push(b);
            ...
            setAxisTranslation: function(a) {
                ...
                if (r || l || e) {
                    ...
                    c ? (k = c.minPointOffset, w = c.pointRangePadding) : b.series.forEach(function(a) {
                        var d =
                            l ? 1 : r ? h(a.options.pointRange, p, 0) : b.axisPointRange || 0,
            ...
            setTickInterval: function(a) {
                ...
                v && z(b.dataMin) && (q = q || 0, !z(t) && b.min < q && b.dataMin >= q ? b.min =
                    b.options.minRange ? Math.min(q, b.max - b.minRange) : q : !z(y) && b.max > q && b.dataMax <= q && (b.max = b.options.minRange ? Math.max(q, b.min + b.minRange) : q));
            ...
            zoom: function(a, b) {
                ...
                L(this, "zoom", a, function(a) {
                    ...
                    if (b !== this.min || m !== this.max) this.allowZoomOutside || (z(d) && (b < k && (b = k), b > w && (b = w)), z(e) && (m < k && (m = k), m > w && (m = w))),
                        this.displayBtn = void 0 !== b || void 0 !== m, this.setExtremes(b, m, !1, void 0, {
                            trigger: "zoom"
                        });
                    a.zoomed = !0
                });
            ...
            setAxisSize: function() {
                ...
                b = this.left = Math.round(c.relativeLength(h(b.left,
            ...
            unsquish: function() {
                var a = this.options.labels,
                    ...
                    g, r = a.rotation,
                    x = this.labelMetrics(),
                    p, A = Number.MAX_VALUE,
                    u, n = this.max - this.min,
                    f = function(a) {
                        var b = a / (c || 1);
                        b = 1 < b ? Math.ceil(b) : 1;
                        b * e > n && Infinity !== a && Infinity !== c && n && (b = Math.ceil(n /
                            e));
                        return d(b * e)
                    };
            ...
            renderUnsquish: function() {
                ...
                if (this.labelAlign =
                    k.align || this.autoLabelAlign(this.labelRotation)) x.align = this.labelAlign;
                d.forEach(function(a) {
                    var b = (a = e[a]) && a.label,
                        d = c.width,
                        k = {};
                ...
                this.tickRotCorr = b.rotCorr(p.b, this.labelRotation || 0, 0 !==
                    this.side)
            },
            hasData: function() {
            ...
            addTitle: function(a) {
                ...
                this.axisTitle || ((c = k.textAlign) || (c = (d ? {
                        ...
                        align: c
                    }).addClass("Mychart-axis-title"),
                    l || this.axisTitle.css(u(k.style)), this.axisTitle.add(this.axisGroup), this.axisTitle.isNew = !0);
            ...
            getOffset: function() {
                ...
                }).addClass("Mychart-" + this.coll.toLowerCase() + "-grid " + (v || "")).add(t), a.axisGroup = d.g("axis").attr({
                    zIndex: e.zIndex || 2
                }).addClass("Mychart-" + this.coll.toLowerCase() + " " + (v || "")).add(t), a.labelGroup = d.g("axis-labels").attr({
                    zIndex: n.zIndex || 7
                }).addClass("Mychart-" + a.coll.toLowerCase() +
                    "-labels " + (v || "")).add(t));
                ...
                if (u && u.text && !1 !== u.enabled && (a.addTitle(x), x && !1 !== u.reserveSpace)) {
                    a.titleOffset =
                        p = a.axisTitle.getBBox()[l ? "height" : "width"];
                    var B = u.offset;
                ...
                E[g] = Math.max(E[g], a.axisTitleMargin + p + q * a.offset, A, k && k.length && l ? l[0] +
                    q * a.offset : 0);
            ...
            renderLine: function() {
                this.axisLine || (this.axisLine = this.chart.renderer.path().addClass("Mychart-axis-line").add(this.axisGroup),
            ...
            renderTick: function(a, b) {
                ...
                if (!d || a >= this.min && a <= this.max) e[a] || (e[a] = new A(this, a)), k && e[a].isNew &&
            ...
            drawCrosshair: function(b, d) {
                ...
                if (this.crosshair && !1 !== (z(d) || !c)) {
                    c ? z(d) &&
                        (l = h("colorAxis" !== this.coll ? d.crosshairPos : null, this.isXAxis ? d.plotX : this.len - d.plotY)) : l = b && (this.horiz ? b.chartX - this.pos : this.len - b.chartY + this.pos);
                    ...
                    g || (this.cross = g = this.chart.renderer.path().addClass("Mychart-crosshair Mychart-crosshair-" + (c ? "category " : "thin ") + k.className).attr({
                            zIndex: h(k.zIndex, 2)
    ...
    M(I, "parts/DateTimeAxis.js", [I["parts/Globals.js"]], function(c) {
        ...
        f.prototype.normalizeTimeTickInterval = function(c, f) {
            ...
            var t = z[f[0]],
                B = f[1],
                y;
            for (y = 0; y < v.length && !(f = v[y], t = z[f[0]],
                    B = f[1], v[y + 1] && c <= (t * B[B.length - 1] + z[v[y + 1][0]]) / 2); y++);
    ...
    M(I, "parts/LogarithmicAxis.js", [I["parts/Globals.js"], I["parts/Utilities.js"]], function(c, f) {
        ...
        f.prototype.getLogTickPositions = function(c, f, v, C) {
            ...
            if (.5 <= c) c = Math.round(c), h = this.getLinearTickPositions(c,
                f, v);
            else if (.08 <= c) {
                y = Math.floor(f);
                var n, q;
            ...
            } else f = this.lin2log(f), v = this.lin2log(v), c = C ? this.getMinorTickInterval() : t.tickInterval, c = F("auto" === c ? null : c, this._minorAutoInterval, t.tickPixelInterval / (C ? 5 : 1) * (v - f) / ((C ? y / this.tickPositions.length : y) || 1)), c = z(c, null, G(c)), h = this.getLinearTickPositions(c,
                f, v).map(this.log2lin), C || (this._minorAutoInterval = c / 5);
        ...
        c.PlotLineOrBand.prototype = {
            render: function() {
                ...
                var f = this,
                    ...
                    w = b.events;
                r = {
                    "class": "Mychart-plot-" + (E ? "band " : "line ") + (b.className || "")
                };
                var m = {},
                    K = q.chart.renderer,
                    J = E ? "bands" : "lines";
                q.isLog && (l = q.log2lin(l), e = q.log2lin(e), L = q.log2lin(L));
                q.chart.styledMode || (p ? (r.stroke = x || "#999999", r["stroke-width"] = y(b.width,
                    1), b.dashStyle && (r.dashstyle = b.dashStyle)) : E && (r.fill = x || "#e6ebf5", b.borderWidth && (r.stroke = b.borderColor, r["stroke-width"] = b.borderWidth)));
                m.zIndex = A;
                J += "-" + A;
        ...
        C(f.prototype, {
            getPlotBandPath: function(c, h) {
                ...
                if (b && g) {
                    ...
                    for (c = 0; c < b.length; c += 6) d && g[c + 1] === b[c + 1] ? (g[c + 1] += e, g[c + 4] += e) : d || g[c + 2] !== b[c + 2] || (g[c + 2] += e, g[c + 5] += e), a.push("M", b[c + 1], b[c + 2], "L", b[c + 4], b[c + 5], g[c + 4], g[c + 5], g[c + 1], g[c + 2], "z"),
                        a.isFlat = l
                }
                return a
            },
    ...
    M(I, "parts/Tooltip.js", [I["parts/Globals.js"], I["parts/Utilities.js"]], function(c, f) {
        ...
        c.Tooltip.prototype = {
            ...
            applyFilter: function() {
                ...
                c.renderer.definition({
                    tagName: "style",
                    textContent: ".Mychart-tooltip-" + c.index + "{filter:url(#drop-shadow-" + c.index + ")}"
                })
            },
            getLabel: function() {
                var g = this,
                    ...
                    l;
                if (!this.label) {
                    this.outside && (this.container = l = c.doc.createElement("div"), l.className = "Mychart-tooltip-container", c.css(l, {
                        position: "absolute",
                        top: "1px",
                    ...
                    a && (this.applyFilter(), this.label.addClass("Mychart-tooltip-" + this.chart.index));
            ...
            getPosition: function(c,
                ...
                var d = this.chart,
                    ...
                    m = function(l) {
                        var m = "x" === l;
                        return [l, m ? f : k, m ? c : b].concat(p ? [m ? A(c) : w(b), m ? r.left - e +
                            A(a.plotX + d.plotLeft) : r.top - e + w(a.plotY + d.plotTop), 0, m ? f : k
                        ] : [m ? c : b, m ? a.plotX + d.plotLeft : a.plotY + d.plotTop, m ? d.plotLeft : d.plotTop, m ? d.plotLeft + d.plotWidth : d.plotTop + d.plotHeight])
                    },
                    n = m("y"),
                    J = m("x"),
            ...
            refresh: function(g, b) {
                ...
                if (d.enabled) {
                    ...
                    a = f.call(l, this);
                    f = e.series;
                    this.distance = v(f.tooltipOptions.distance,
                        16);
                    !1 === a ? this.hide() : (this.split ? this.renderSplit(a, C(g)) : (g = this.getLabel(), d.style.width && !p || g.css({
                        width: this.chart.spacingBox.width
                    }), g.attr({
                        text: a && a.join ? a.join("") : a
                    }), g.removeClass(/Mychart-color-[\d]+/g).addClass("Mychart-color-" + v(e.colorIndex, f.colorIndex)), p || g.attr({
                ...
                g.slice(0, b.length + 1).forEach(function(c, m) {
                    if (!1 !== c && "" !== c) {
                        ...
                        var g = m.series || a,
                            x = g.tt,
                            w = m.series || {},
                            A = "Mychart-color-" + v(m.colorIndex, w.colorIndex, "none");
                        x || (x = {
                                padding: f.padding,
                                r: f.borderRadius
                            }, e.styledMode || (x.fill = f.backgroundColor, x["stroke-width"] = f.borderWidth),
                            g.tt = x = l.label(null, null, null, (m.isHeader ? f.headerShape : f.shape) || "callout", null, null, f.useHTML).addClass(m.isHeader ? "Mychart-tooltip-header " : "Mychart-tooltip-box " + A).attr(x).add(k));
                        x.isActive = !0;
                        x.attr({
                            text: c
                        });
                        ...
                        m.isHeader ? (p = c.height, e.xAxis[0].opposite && (u = !0, r -= p), c = Math.max(0, Math.min(m.plotX + e.plotLeft - A / 2, e.chartWidth + (e.scrollablePixelsX ?
                            e.scrollablePixelsX - e.marginRight : 0) - A))) : c = m.plotX + e.plotLeft - v(f.distance, 16) - A;
                        0 > c && (h = !1);
            ...
            styledModeFormat: function(c) {
                return c.replace('style="font-size: 10px"', 'class="Mychart-header"').replace(/style="color:{(point|series)\.color}"/g, 'class="Mychart-color-{$1.colorIndex}"')
            }
        }
    });
    M(I, "parts/Pointer.js", [I["parts/Globals.js"], I["parts/Utilities.js"]], function(c, f) {
        ...
        c.Pointer.prototype = {
            ...
            reset: function(a, b) {
                ...
                if (a) k && l && H(l).length && (k.refresh(l),
            ...
            drag: function(a) {
                ...
                if (!m || !m.touch)
                    if (e < r ? e = r : e > r + A && (e = r + A), c < h ? c = h : c > h + w && (c = h + w), this.hasDragged = Math.sqrt(Math.pow(f - e, 2) + Math.pow(J - c, 2)), 10 < this.hasDragged) {
                        var q = b.isInsidePlot(f - r, J - h);
                        b.hasCartesianSeries && (this.zoomX || this.zoomY) && q && !v && !m && (this.selectionMarker =
                            m = b.renderer.rect(r, h, g ? 1 : A, k ? 1 : w, 0).attr({
                                "class": "Mychart-selection-marker",
                                zIndex: 7
            ...
            drop: function(a) {
                ...
                if (this.selectionMarker) {
                    ...
                    B(e.index) && (this.selectionMarker =
            ...
            onDocumentMouseMove: function(a) {
                ...
                !d || this.inClass(a.target, "Mychart-tracker") || b.isInsidePlot(a.chartX - b.plotLeft, a.chartY - b.plotTop) || this.reset()
            },
            ...
            onContainerMouseMove: function(a) {
                ...
                !this.inClass(a.target, "Mychart-tracker") && !b.isInsidePlot(a.chartX - b.plotLeft, a.chartY - b.plotTop) || b.openMenu || this.runPointActions(a)
            },
            inClass: function(a, b) {
                for (var d; a;) {
                    if (d = F(a, "class")) {
                        if (-1 !== d.indexOf(b)) return !0;
                        if (-1 !== d.indexOf("Mychart-container")) return !1
                    }
                    a = a.parentNode
                }
            },
            onTrackerMouseOut: function(a) {
                ...
                if (!(!b || !a || b.stickyTracking || this.inClass(a, "Mychart-tooltip") ||
                        this.inClass(a, "Mychart-series-" + b.index) && this.inClass(a, "Mychart-tracker"))) b.onMouseOut()
            },
            onContainerClick: function(a) {
                var d = this.chart,
                    ...
                    g = d.plotTop;
                a = this.normalize(a);
                d.cancelClick || (e && this.inClass(a.target, "Mychart-tracker") ? (b(e.series, "click", z(a, {
                    point: e
            ...
            setDOMEvents: function() {
                ...
                }), c.unbindDocumentTouchEnd || (c.unbindDocumentTouchEnd = y(d, "touchend",
        ...
        F(c.Pointer.prototype, {
            ...
            pinch: function(c) {
                var f = this,
                    ...
                    g = f.selectionMarker,
                    b = {},
                    a = 1 === h && (f.inClass(c.target, "Mychart-tracker") && t.runTrackerClick || f.runChartClick),
                    d = {};
                1 < h && (f.initiated = !0);
            ...
            var n = {},
                ...
                b = function(a, b, e, l) {
                    "touch" !== a.pointerType && a.pointerType !== a.MSPOINTER_TYPE_TOUCH ||
                        !B[c.hoverChartIndex] || (l(a), l = B[c.hoverChartIndex].pointer, l[b]({
                            type: e,
    ...
    M(I, "parts/Legend.js", [I["parts/Globals.js"], I["parts/Utilities.js"]], function(c, f) {
        ...
        c.Legend.prototype = {
            ...
            colorizeItem: function(b, a) {
                b.legendGroup[a ? "removeClass" : "addClass"]("Mychart-legend-item-hidden");
            ...
            destroy: function() {
                ...
                "clipRect up down pager nav box title group".split(" ").forEach(b,
                    this);
                this.display = null
            },
            ...
            renderTitle: function() {
                ...
                d.text && (this.title || (this.title = this.chart.renderer.label(d.text,
                    a - 3, a - 4, null, null, null, b.useHTML, null, "legend-title").attr({
                    zIndex: 1
            ...
            renderItem: function(b) {
                ...
                r || (b.legendGroup = d.g("legend-item").addClass("Mychart-" + A.type + "-series Mychart-color-" + b.colorIndex + (n ? " " + n : "") + (x ? " Mychart-series-" + b.index :
                    "")).attr({
                    zIndex: 1
            ...
            proximatePositions: function() {
                ...
                this.allItems.forEach(function(e) {
                    ...
                    if (e.yAxis && e.points) {
                        ...
                        var h = c.find(g ? e.points :
                            e.points.slice(0).reverse(),
                            function(a) {
                                return z(a.plotY)
                            });
            ...
            render: function() {
                ...
                u += q;
                g || (this.box = g = a.rect().addClass("Mychart-legend-box").attr({
                    r: f.borderRadius
                }).add(d), g.isNew = !0);
                b.styledMode || g.attr({
                ...
                this.legendWidth = p;
                this.legendHeight = u;
                e && (a = b.spacingBox, g = a.y, /(lth|ct|rth)/.test(this.getAlignment()) && 0 < b.titleOffset[0] ? g += b.titleOffset[0] : /(lbh|cb|rbh)/.test(this.getAlignment()) && 0 < b.titleOffset[2] && (g -= b.titleOffset[2]), g !==
                    a.y && (a = h(a, {
                        y: g
                    })), d.align(h(f, {
                        width: p,
            ...
            handleOverflow: function(b) {
                ...
                f && (g = Math.min(g, f));
                m.length = 0;
                b > g && !1 !== r.enabled ? (this.clipHeight = u = Math.max(g - 20 - this.titleHeight - h, 0), this.currentPage = B(this.currentPage, 1), this.fullHeight =
                    b, J.forEach(function(a, b) {
                        ...
                        e.text("", 15, 10).addClass("Mychart-legend-navigation"), d.styledMode || this.pager.css(r.style), this.pager.add(w), this.down = e.symbol("triangle-down", 0, 0, A, A).add(w), v("downTracker").on("click", function() {
                            a.scroll(1, x)
            ...
            scroll: function(b, a) {
                ...
                c > e && (c = e);
                0 < c && (void 0 !==
                    a && t(a, this.chart), this.nav.attr({
                        translateX: f,
                        translateY: b + this.padding + 7 + this.titleHeight,
                        visibility: "visible"
                    }), [this.up, this.upTracker].forEach(function(a) {
                        a.attr({
                            "class": 1 === c ? "Mychart-legend-nav-inactive" : "Mychart-legend-nav-active"
                        })
                    }), h.attr({
                        text: c + "/" + e
                        ...
                        a.attr({
                            ...
                            "class": c === e ? "Mychart-legend-nav-inactive" : "Mychart-legend-nav-active"
                        })
        ...
        c.LegendSymbolMixin = {
            drawRectangle: function(b, a) {
                ...
                a.legendSymbol = this.chart.renderer.rect(e ? (b.symbolWidth - d) / 2 : 0, b.baseline -
                    d + 1, e ? d : b.symbolWidth, d, B(b.options.symbolRadius, d / 2)).addClass("Mychart-point").attr({
                    zIndex: 3
                }).add(a.legendGroup)
            },
            drawLineMarker: function(b) {
                ...
                this.legendLine = f.path(["M", 0, b, "L", e, b]).addClass("Mychart-graph").attr(u).add(p);
                d && !1 !==
                    d.enabled && e && (a = Math.min(B(d.radius, g), g), 0 === this.symbol.indexOf("url") && (d = h(d, {
                        width: c,
                        height: c
                    }), a = 0), this.legendSymbol = d = f.symbol(this.symbol, e / 2 - a, b - a, 2 * a, 2 * a, d).addClass("Mychart-point").add(p), d.isMarker = !0)
            }
        };
    ...
    M(I, "parts/Chart.js", [I["parts/Globals.js"], I["parts/Utilities.js"]], function(c,f) {
        ...
        t(O.prototype, {
            ...
            redraw: function(a) {
                ...
                if (u)
                    for (a = d.length; a--;) w = d[a], w.options.stacking && (w.isDirty = !0);
                d.forEach(function(a) {
            ...
            temporaryDisplay: function(a) {
                var b = this.renderTo;
                if (a)
                    for (; b && b.style;) b.hcOrigStyle && (c.css(b, b.hcOrigStyle), delete b.hcOrigStyle), b.hcOrigDetached && (L.body.removeChild(b),
            ...
            getContainer: function() {
                ...
                d || c.error(13, !0, this);
                var h = q(F(d, "data-Mychart-chart"));
                C(h) && k[h] && k[h].hasRendered && k[h].destroy();
                F(d, "data-Mychart-chart", this.index);
                d.innerHTML = "";
                ...
                if (this.styledMode)
                    for (m in a.defs) this.renderer.definition(a.defs[m]);
            ...
            drawChartBox: function() {
                var a = this.options.chart,
                    ...
                    q = this.clipBox,
                    v = "animate";
                c || (this.chartBackground = c = b.rect().addClass("Mychart-background").add(), v = "attr");
                ...
                v = "animate";
                k || (v = "attr", this.plotBackground = k = b.rect().addClass("Mychart-plot-background").add());
                k[v](J);
                m || (k.attr({
                    fill: l || "none"
                ...
                v = "animate";
                g || (v = "attr", this.plotBorder = g = b.rect().addClass("Mychart-plot-border").attr({
                    zIndex: 1
                }).add());
                m || g.attr({
            ...
            linkSeries: function() {
                ...
                b.forEach(function(b) {
                    ...
                    y(d) && (d = ":previous" === d ? a.series[b.index - 1] : a.get(d)) && d.linkedParent !== b && (d.linkedSeries.push(b), b.linkedParent = d, b.visible =
            ...
            destroy: function() {
                ...
                c.chartCount--;
                a.renderTo.removeAttribute("data-Mychart-chart");
                U(a);
    ...
    M(I, "parts/ScrollablePlotArea.js", [I["parts/Globals.js"], I["parts/Utilities.js"]], function(c, f) {
        ...
        f.prototype.setUpScrolling = function() {
            ...
            this.scrollingContainer = c.createElement("div", {
                className: "Mychart-scrolling"
            }, f, this.renderTo);
            this.innerContainer = c.createElement("div", {
                className: "Mychart-inner-container"
        ...
        f.prototype.moveFixedElements = function() {
            var c = this.container,
                ...
                t = ".Mychart-contextbutton .Mychart-credits .Mychart-legend .Mychart-legend-checkbox .Mychart-navigator-series .Mychart-navigator-xaxis .Mychart-navigator-yaxis .Mychart-navigator .Mychart-reset-zoom .Mychart-scrollbar .Mychart-subtitle .Mychart-title".split(" "),
                v;
            this.scrollablePixelsX && !this.inverted ? v = ".Mychart-yaxis" : this.scrollablePixelsX && this.inverted ? v = ".Mychart-xaxis" : this.scrollablePixelsY && !this.inverted ? v = ".Mychart-xaxis" : this.scrollablePixelsY && this.inverted && (v = ".Mychart-yaxis");
            t.push(v, v + "-labels");
        ...
        f.prototype.applyFixed = function() {
            ...
            B ? (this.fixedDiv = c.createElement("div", {
                    ...
                    zIndex: -1
                }).addClass("Mychart-scrollable-mask").add(),
                this.moveFixedElements(), G(this, "afterShowResetZoom", this.moveFixedElements), G(this, "afterLayOutTitles", this.moveFixedElements)) : this.fixedRenderer.setSize(this.chartWidth, this.chartHeight);
        ...
        c.Point.prototype = {
            ...
            resolveColor: function() {
                ...
                c.options.colorByPoint ?
                    (a || (b = c.options.colors || c.chart.options.colors, this.color = this.color || b[c.colorCounter], b = b.length), a = c.colorCounter, c.colorCounter++, c.colorCounter === b && (c.colorCounter = 0)) : a = c.colorIndex;
            ...
            applyOptions: function(c, b) {
                ...
                d && (this.y = this[d]);
                this.formatPrefix =
                    (this.isNull = C(this.isValid && !this.isValid(), null === this.x || !t(this.y))) ? "null" : "point";
            ...
            optionsToObject: function(g) {
                ...
                if (t(g) || null === g) b[e[0]] = g;
                    ...
                    for (!d && g.length > h && (a = typeof g[0], "string" === a ? b.name = g[0] : "number" === a && (b.x = g[0]), f++); n < h;) d && void 0 === g[f] || (0 < e[n].indexOf(".") ? c.Point.prototype.setNestedProperty(b, g[f], e[n]) : b[e[n]] = g[f]), f++, n++;
                else "object" === typeof g && (b = g, g.dataLabels && (a._hasPointLabels = !0), g.marker && (a._hasPointMarkers = !0));
                return b
            },
            getClassName: function() {
                return "Mychart-point" + (this.selected ? " Mychart-point-select" : "") + (this.negative ? " Mychart-negative" :
                    "") + (this.isNull ? " Mychart-null-point" : "") + (void 0 !== this.colorIndex ? " Mychart-color-" + this.colorIndex : "") + (this.options.className ? " " + this.options.className : "") + (this.zone && this.zone.className ? " " + this.zone.className.replace("Mychart-negative", "") : "")
            },
            getZone: function() {
                var c = this.series,
                    b = c.zones;
    ...
    M(I, "parts/Series.js", [I["parts/Globals.js"], I["parts/Utilities.js"]], function(c, f) {
        ...
        c.Series = c.seriesType("line", null, {
            ...
            autoIncrement: function() {
                ...
                this.pointInterval = d = h(this.pointInterval,
                    a.pointInterval, 1);
            ...
            setOptions: function(a) {
                ...
                k = L(f, e.series, k.plotOptions &&
                    k.plotOptions[this.type], a);
            ...
            findPointIndex: function(a,
                ...
                void 0 === k && C(a) && (k = this.xData.indexOf(a, b)); - 1 !== k && void 0 !== k && this.cropped && (k = k >= this.cropStart ? k - this.cropStart : k);
            ...
            updateData: function(a) {
                ...
                a.forEach(function(a, k) {
                    ...
                    var r = m.x;
                    if (m.id || C(r))
                        if (r = this.findPointIndex(m, g), -1 === r || void 0 === r ? c.push(a) : d[r] && a !== b.data[r] ? (d[r].update(a, !1, null, !1), d[r].touched = !0, h && (g = r + 1)) : d[r] && (d[r].touched = !0), !f || k !== r || this.hasDerivedData) e = !0
                }, this);
                if (e)
                    for (a = d.length; a--;)(k = d[a]) && !k.touched && k.remove(!1);
            ...
            setData: function(a, b, d, e) {
                ...
                if (!L) {
                    ...
                    if (x && r > x)
                        if (x = k.getFirstValidPoint(a), C(x))
                            for (d = 0; d < r; d++) u[d] =
                                this.autoIncrement(), n[d] = a[d];
                        else if (v(x))
                        if (q)
                            for (d = 0; d < r; d++) e = a[d], u[d] = e[0], n[d] = e.slice(1, q + 1);
                        else
                            for (y && (t = y.indexOf("x"), E = y.indexOf("y"), t = 0 <= t ? t : 0, E = 0 <= E ? E : 1), d = 0; d < r; d++) e = a[d], u[d] = e[t], n[d] = e[E];
                    else c.error(12, !1, p);
                    else
                        for (d = 0; d < r; d++) void 0 !== a[d] && (e = {
                            series: k
            ...
            processData: function(a) {
                ...
                if (p && this.sorted && !l && (!f || e > f || this.forceCrop))
                    if (b[e - 1] < q || b[0] > v) b = [], d = [];
                ...
                for (f = b.length || 1; --f;)
                    if (e = u ? h(b[f]) - h(b[f - 1]) : b[f] - b[f - 1], 0 < e && (void 0 === t || e < t)) var t = e;
            ...
            generatePoints: function() {
                ...
                for (v = 0; v < h; v++) {
                    ...
                    if (u) {
                        var E =
                            (new f).init(this, [c[v]].concat(n(g[v])));
                ...
                this.options.keys = a;
                if (d && (h !== (e = d.length) || u))
                    for (v = 0; v < e; v++) v !== p || u || (v += h), d[v] && (d[v].destroyElements(), d[v].plotX = void 0);
                this.data = d;
                this.points = q;
            ...
            translate: function() {
                ...
                for (u = 0; u < f; u++) {
                    ...
                    v(Y) && (I = Y[0], F = Y[1], I === t && X.key === M[G].base && (I = h(C(y) && y, g.min)), g.positiveValuesOnly && 0 >= I && (I = null), H.total = H.stackTotal = P.total, H.percentage =
                        P.total && H.y / P.total * 100, H.stackY = F, this.irregularWidths || P.setOffset(this.pointXOffset || 0, this.barW || 0));
            ...
            setClip: function(a) {
                var b = this.chart,
                    ...
                    h = b[f],
                    l = b[f + "m"];
                h || (a && (g.width = 0, c && (g.x = b.plotSizeX + (!1 !== d.clip ? 0 : b.plotTop)), b[f + "m"] = l = e.clipRect(c ? b.plotSizeX + 99 : -99,
                    c ? -b.plotLeft : -b.plotTop, 99, c ? b.chartWidth : b.chartHeight)), b[f] = h = e.clipRect(g), h.count = {
                    length: 0
                });
            ...
            drawPoints: function() {
                ...
                var g = this.xAxis;
                var f = h(e.enabled, !g || g.isRadial ? !0 : null, this.closestPointRangePx >= e.enabledThreshold *
                    e.radius);
                if (!1 !== e.enabled || this._hasPointMarkers)
                    for (g = 0; g < a.length; g++) {
                        ...
                        if (q && !l.isNull) {
                            ...
                            if (d && !b.styledMode) d[p](this.pointAttribs(l, l.selected &&
                                "select"));
            ...
            getGraphPath: function(a, b, d) {
                ...
                a.forEach(function(g, m) {
                    ...
                    g.isNull && !z(b) && 0 < m ? l = !c.connectNulls : g.isNull && !b ? l = !0 : (0 === m || l ? m = ["M", g.plotX, g.plotY] : e.getPointSpline ? m = e.getPointSpline(a, g, m) : k ? (m = 1 === k ? ["L", u.plotX, p] : 2 === k ? ["L", (u.plotX + r) / 2, u.plotY,
                        "L", (u.plotX + r) / 2, p
                    ] : ["L", r, u.plotY], m.push("L", r, p)) : m = ["L", r, p], h.push(g.x), k && (h.push(g.x), 2 === k && h.push(g.x)), f.push.apply(f, m), l = !1)
                });
                f.xMap = h;
            ...
            getZonesGraphs: function(a) {
                this.zones.forEach(function(b, d) {
                    d = ["zone-graph-" + d, "Mychart-graph Mychart-zone-graph-" + d + " " + (b.className ||
                        "")];
            ...
            applyZones: function() {
                ...
                if (e.length && (p || u) && q && void 0 !== q.min) {
                    ...
                    e.forEach(function(e, k) {
                        c = L ? z ?
                            b.plotWidth : 0 : z ? 0 : q.toPixels(B.min) || 0;
                        ...
                        f[k] ?
                            f[k].animate(l) : f[k] = d.clipRect(l);
            ...
            plotGroup: function(a, b, d, e, c) {
                ...
                k.addClass("Mychart-" + b + " Mychart-series-" + this.index + " Mychart-" + this.type + "-series " + (z(this.colorIndex) ? "Mychart-color-" + this.colorIndex + " " : "") + (this.options.className || "") + (k.hasClass("Mychart-tracker") ? " Mychart-tracker" : ""), !0);
                k.attr({
                    visibility: d
        ...
        H.prototype.setStackedPoints = function() {
            if (this.options.stacking && (!0 === this.visible || !1 === this.chart.options.chart.ignoreHiddenSeries)) {
                ...
                for (r = 0; r < q; r++) {
                    ...
                    "percent" === g ? (k = k ? e :
                        l, t && p[k] && p[k][x] ? (k = p[k][x], K.total = k.total = Math.max(k.total, K.total) + Math.abs(A) || 0) : K.total = v(K.total + (Math.abs(A) || 0))) : K.total = v(K.total + (A || 0));
    ...
    M(I, "parts/Dynamics.js", [I["parts/Globals.js"], I["parts/Utilities.js"]], function(c, f) {
        ...
        c.cleanRecursively = function(a, b) {
            var d = {};
            H(a, function(e, g) {
                if (v(a[g], !0) && !a.nodeType && b[g]) e = c.cleanRecursively(a[g], b[g]), Object.keys(e).length && (d[g] = e);
        ...
        z(f.prototype, {
            ...
            showLoading: function(b) {
                ...
                f || (c.loadingDiv = f = a("div", {
                        className: "Mychart-loading Mychart-loading-hidden"
                    },
                    null, c.container), c.loadingSpan = a("span", {
                    className: "Mychart-loading-inner"
                }, null, f), q(c, "redraw", l));
                f.className = "Mychart-loading";
            ...
            hideLoading: function() {
                var a = this.options,
                    b = this.loadingDiv;
                b && (b.className = "Mychart-loading Mychart-loading-hidden",
                    this.styledMode || g(b, {
                        opacity: 0
                    }, {
            ...
            update: function(a, b, d, g) {
                ...
                if (h = a.chart) {
                    ...
                    "alignTicks" in h && (x = !0);
                    H(h, function(a, b) {
                        -1 !== k.propsRequireUpdateSeries.indexOf("chart." + b) && (p = !0); - 1 !== k.propsRequireDirtyBox.indexOf(b) && (k.isDirtyBox = !0);
        ...
        z(L.prototype, {
            update: function(a, b, d, c) {
                function e() {
                    ...
                    v(a, !0) && (f && f.element && a &&
                        a.marker && void 0 !== a.marker.symbol && (g.graphic = f.destroy()), a && a.dataLabels && g.dataLabel && (g.dataLabel = g.dataLabel.destroy()), g.connector && (g.connector = g.connector.destroy()));
                    h = g.index;
        ...
        z(E.prototype, {
            addPoint: function(a, b, d, c, g) {
                ...
                var q = u.x;
                var x = r.length;
                if (this.requireSorting && q < r[x - 1])
                    for (n = !0; x && r[x - 1] > q;) x--;
            ...
            update: function(a, b) {
                ...
                var d = this,
                    ...
                    u = p[f].prototype,
                    q, v = ["group", "markerGroup", "dataLabelsGroup", "transformGroup"],
                    t = ["eventOptions", "navigatorSeries", "baseSeries"],
                    E = d.finishedAnimating && {
                        animation: !1
                    },
                    C = {};
                n && (t.push("data", "isDirtyData", "points", "processedXData", "processedYData", "xIncrement", "_hasPointMarkers", "_hasPointLabels", "mapMap", "mapData", "minY", "maxY", "minX", "maxX"), !1 !== a.visible && t.push("area",
                    "graph"), d.parallelArrays.forEach(function(a) {
                    t.push(a + "Data")
        ...
        z(b.prototype, {
            ...
            remove: function(a) {
                for (var b =
                        this.chart, d = this.coll, c = this.series, e = c.length; e--;) c[e] && c[e].remove(!1);
                G(b.axes, this);
                G(b[d], this);
        ...
        f("area", "line", {
                    ...
                    t.forEach(function(c, g) {
                        ...
                        if (n[c] && !n[c].isNull) f.push(n[c]), [-1, 1].forEach(function(k) {
                            var f = 1 === k ? "rightNull" : "leftNull",
                                ...
                                v = h[t[g + k]];
                            if (v)
                                for (d = q; 0 <= d && d < b;) p = v.points[d], p || (d === q ? n[c][f] = !0 : e[d] && (u = h[c].points[d]) && (l -= u[1] - u[0])), d += a;
            ...
            drawGraph: function() {
                ...
                var c = this,
                    ...
                    C = this.options,
                    H = [
                        ["area", "Mychart-area", this.color, C.fillColor]
                    ];
                this.zones.forEach(function(f, h) {
                    H.push(["zone-area-" + h, "Mychart-area Mychart-zone-area-" + h + " " + f.className, f.color || c.color, f.fillColor || C.fillColor])
                });
    ...
    M(I, "parts/ColumnSeries.js", [I["parts/Globals.js"], I["parts/Utilities.js"]], function(c, f) {
        ...
        f("column", "line", {
            ...
            drawLegendSymbol: c.LegendSymbolMixin.drawRectangle,
            drawGraph: function() {
                this.group[this.dense ? "addClass" : "removeClass"]("Mychart-dense-data")
            },
            pointAttribs: function(c, f) {
                ...
                f && (c = C(h.states[f], c.options.states && c.options.states[f] || {}), f = c.brightness, d = c.color || void 0 !== f && v(d).brighten(c.brightness).get() || d, e = c[b] || e, l = c[a] ||
                    l, g = c.dashStyle || g, n = B(c.opacity, n));
                b = {
                    fill: d,
                    stroke: e,
                    "stroke-width": l,
            ...
            drawPoints: function() {
                ...
                c.points.forEach(function(d) {
                    ...
                    if (z(d.plotY) && null !== d.y) {
                        ...
                        f.styledMode ||
                            e[l](c.pointAttribs(d, d.selected && "select")).shadow(!1 !== d.allowShadow && q.shadow, null, q.stacking && !q.borderRadius);
            ...
            animate: function(c) {
                ...
                if (y)
                    if (c) a.scaleY = .001, c = Math.min(h.pos + h.len, Math.max(h.pos, h.toPixels(g.threshold))), b ? a.translateX = c - h.len : a.translateY = c, f.clipBox && f.setClip(), f.group.attr(a);
                    else {
    ...
    M(I, "parts/PieSeries.js", [I["parts/Globals.js"], I["parts/Utilities.js"]], function(c, f) {
        ...
        n("pie", "line", {
            ...
            updateTotals: function() {
                ...
                this.total = b;
                for (c = 0; c < d; c++) f = a[c], f.percentage =
            ...
            translate: function(g) {
                ...
                for (u = 0; u < k; u++) {
                    ...
                    r.labelDistance = c.relativeLength(r.labelDistance,
                        r.shapeArgs.r);
            ...
            drawEmpty: function() {
                ...
                if (0 === this.total) {
                    var b = this.center[0];
                    var a = this.center[1];
                    this.graph || (this.graph = this.chart.renderer.circle(b, a, 0).addClass("Mychart-graph").add(this.group));
                    this.graph.animate({
    ...
    M(I, "parts/DataLabels.js", [I["parts/Globals.js"], I["parts/Utilities.js"]], function(c, f) {
        ...
        c.distribute = function(b, a, d) {
            ...
            for (b = b.map(function(a) {
                ...
                for (f = b.length; f--;) h = b[f], u = (Math.min.apply(0, h.targets) +
                    Math.max.apply(0, h.targets)) / 2, h.pos = Math.min(Math.max(0, u - h.size * h.align), a - h.size);
                f = b.length;
            ...
            b.some(function(b) {
                ...
                if (b.targets.some(function() {
                        ...
                        if (Math.abs(n[f].pos - n[f].target) > d) return n.slice(0, f + 1).forEach(function(a) {
                            ...
                            (n.reducedLen || a) - .1 * a, n.reducedLen > .1 * a && c.distribute(n, a, d), !0;
                        e += n[f].size;
                        f++
                    })) return !0
            });
        ...
        n.prototype.drawDataLabels = function() {
            ...
            if (B(g) || g.enabled || d._hasPointLabels) {
                var w =
                    d.plotGroup("dataLabelsGroup", "data-labels", q && !n ? "hidden" : "inherit", g.zIndex || 6);
                q && (w.attr({
                    opacity: +n
                ...
                h.forEach(function(c) {
                    ...
                    p.forEach(function(a, g) {
                        ...
                        if (k) {
                            ...
                            e.styledMode ||
                                (q.fill = a.backgroundColor, q.stroke = a.borderColor, q["stroke-width"] = a.borderWidth);
                            t(q, function(a, b) {
                                void 0 === a && delete q[b]
                            })
                        }!h || k && G(r) ? k && G(r) && (h ? q.text = r : (c.dataLabels = c.dataLabels || [], h = c.dataLabels[g] = u ? A.text(r, 0, -9999).addClass("Mychart-data-label") : A.label(r, 0, -9999, a.shape, null, null, a.useHTML, null, "data-label"), g || (c.dataLabel = h), h.addClass(" Mychart-data-label-color-" + c.colorIndex + " " + (a.className || "") + (a.useHTML ? " Mychart-tracker" : ""))), h.options = a, h.attr(q), e.styledMode || h.css(n).shadow(a.shadow),
        ...
        n.prototype.alignDataLabel =
            function(b, a, d, c, f) {
                ...
                if (A) {
                    ...
                    w && 0 <= c.height ? this.justifyDataLabel(a, d, h, k, c, f) : v(d.crop, !0) && (A = e.isInsidePlot(h.x, h.y) && e.isInsidePlot(h.x +
                        k.width, h.y + k.height));
        ...
        n.prototype.justifyDataLabel = function(b, a, d, c, f, g) {
            ...
            n = d.y + k;
            0 > n && ("bottom" === l ? (a.verticalAlign =
                "top", a.inside = !0) : a.y = -n, q = !0);
            n = d.y + c.height - k;
        ...
        q.pie && (q.pie.prototype.dataLabelPositioners = {
                ...
                b.visible && (f.enabled || b._hasPointLabels) && (a.forEach(function(a) {
                    ...
                    if (h = v(W.connectorWidth, 1)) {
                        ...
                        if ((t = a.dataLabel) && t._pos && a.visible && 0 < a.labelDistance) {
                            ...
                            if (d = !q) a.connector = q = e.renderer.path().addClass("Mychart-data-label-connector  Mychart-color-" + a.colorIndex + (a.className ? " " + a.className : "")).add(b.dataLabelsGroup), e.styledMode || q.attr({
                                "stroke-width": h,
            ...
            function() {
                ...
                if (!g) {
                    ...
                    else n = Math.max(a[2] - b[1] - b[3], f), a[0] += (b[3] - b[1]) / 2;
        ...
        q.column && (q.column.prototype.alignDataLabel = function(b, a, d, c, f) {
            ...
            d.verticalAlign = v(d.verticalAlign, e || k ? "middle" : l ? "top" :
                "bottom");
    ...
    M(I, "modules/overlapping-datalabels.src.js", [I["parts/Globals.js"], I["parts/Utilities.js"]], function(c, f) {
        ...
        f.prototype.hideOverlappingLabels = function(c) {
            ...
            for (n = 0; n < v; n++)
                if (h = c[n]) h.oldOpacity = h.opacity, h.newOpacity = 1, h.absoluteBox =
                    g(h);
            c.sort(function(a, b) {
            ...
            c.forEach(function(a) {
                ...
                if (a) {
                    ...
                    a.oldOpacity !== d && (a.alignAttr && a.placed ? (d ? a.show(!0) : b = function() {
                        a.hide(!0);
                        a.placed = !1
                    }, a.alignAttr.opacity = d, a[a.isOld ?
                        "animate" : "attr"](a.alignAttr, null, b), t(f, "afterHideOverlappingLabels")) : a.attr({
                        opacity: d
                    }));
                    a.isOld = !0
                }
        ...
        var E = c.TrackerMixin = {
            drawTrackerPoint: function() {
                ...
                a._hasTracking || (a.trackerGroups.forEach(function(e) {
                    if (a[e]) {
                        a[e].addClass("Mychart-tracker").on("mouseover", c).on("mouseout", function(a) {
            ...
            drawTrackerGraph: function() {
                ...
                if (e && !d)
                    for (t = e + 1; t--;) "M" === c[t] && c.splice(t + 1, 0, c[t + 1] - n, c[t + 2], "L"), (t && "M" === c[t] || t ===
                        e) && c.splice(t, 0, "L", c[t - 2] + n, c[t - 1]);
                v ? v.attr({
                    d: c
                }) : a.graph && (a.tracker = l.path(c).attr({
                    visibility: a.visible ? "visible" : "hidden",
                    zIndex: 2
                }).addClass(d ? "Mychart-tracker-area" : "Mychart-tracker-line").add(a.group), f.styledMode || a.tracker.attr({
                    "stroke-linejoin": "round",
                    stroke: z,
                    fill: d ? z : "none",
                    "stroke-width": a.graph.strokeWidth() + (d ? 0 : 2 * n)
                }), [a.tracker, a.markerGroup].forEach(function(a) {
                    a.addClass("Mychart-tracker").on("mouseover", y).on("mouseout", function(a) {
        ...
        G(b.prototype, {
            setItemEvents: function(b, c, e) {
                var f = this,
                    ...
                    k = b instanceof d,
                    h = "Mychart-legend-" + (k ? "point" : "series") + "-active",
            ...
            createCheckboxForItem: function(a) {
                a.checkbox = H("input", {
                    type: "checkbox",
                    className: "Mychart-legend-checkbox",
                    checked: a.selected,
        ...
        G(f.prototype, {
            showResetZoom: function() {
                ...
                q(this, "beforeShowResetZoom", null, function() {
                    ...
                    }).addClass("Mychart-reset-zoom").add().align(d.position, !1, g)
                });
            ...
            zoom: function(a) {
                ...
                c && b.redraw(v(b.options.chart.animation,
            ...
            pan: function(a, b) {
                ...
                q(this, "pan", {
                    ...
                    ("xy" === b ? [1, 0] : [1]).forEach(function(b) {
                        ...
                        g = n ? h : p;
                        p = n ? p : h;
                        h = Math.min(l.dataMin,
                            k ? l.min : b.toValue(b.toPixels(l.min) - b.minPixelPadding));
        ...
        G(d.prototype, {
            ...
            setState: function(a, b) {
                ...
                if (!(a === this.state && !b || this.selected && "select" !== a || !1 === e.enabled || a && (l || g && !1 === h.enabled) || a && u.states && u.states[a] && !1 === u.states[a].enabled)) {
                    ...
                    if (this.graphic) {
                        d && this.graphic.removeClass("Mychart-point-" + d);
                        a && this.graphic.addClass("Mychart-point-" +
                            a);
                        if (!t.styledMode) {
                    ...
                    a && a.size && p && "hidden" !== e ? (y || (c.halo = y = t.renderer.path().add(p.parentGroup)), y.show()[b ? "animate" : "attr"]({
                        ...
                        "class": "Mychart-halo Mychart-color-" + v(this.colorIndex, c.colorIndex) +
        ...
        G(e.prototype, {
            ...
            setState: function(a, b) {
                var c = this,
                    ...
                    h = d.lineWidth,
                    l = d.opacity,
                    n = v(g[a || "normal"] && g[a || "normal"].animation,
                        c.chart.options.chart.animation);
                d = 0;
                a = a || "";
                if (c.state !== a && ([c.group, c.markerGroup, c.dataLabelsGroup].forEach(function(b) {
                        b && (c.state && b.removeClass("Mychart-series-" + c.state), a && b.addClass("Mychart-series-" + a))
                    ...
                    f || [c.group, c.markerGroup, c.dataLabelsGroup,
                        c.labelBySeries
                    ].forEach(function(a) {
                        a && a.animate({
                            opacity: l
    ...
    M(I, "parts/Responsive.js", [I["parts/Globals.js"], I["parts/Utilities.js"]], function(c, f) {
        ...
        f.prototype.currentOptions = function(c) {
            function f(c, n, q, g) {
                var b;
                z(c, function(a, c) {
                    if (!g && -1 < v.collectionsWithUpdate.indexOf(c))
                        for (a = t(a), q[c] = [], b = 0; b < a.length; b++) n[c][b] && (q[c][b] = {}, f(a[b], n[c][b], q[c][b], g + 1));
    ...
    M(I, "masters/Mychart.src.js", [I["parts/Globals.js"],I["parts/Utilities.js"]], function(c, f) {
        var F = f.extend;
        F(c, {
            arrayMax: f.arrayMax,
            arrayMin: f.arrayMin,
    ...
    I["masters/Mychart.src.js"]._modules = I;
    return I["masters/Mychart.src.js"]
});