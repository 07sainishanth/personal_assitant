(function(b) {
    "object" === typeof module && module.exports ? (b["default"] = b, module.exports = b) : "function" === typeof define && define.amd ? define("Mychart/modules/solid-gauge", ["Mychart", "Mychart/Mychart-more"], function(k) {
        b(k);
        b.Mychart = k;
        return b
    }) : b("undefined" !== typeof Mychart ? Mychart : void 0)
})(function(b) {
    function k(b, f, k, m) {
        b.hasOwnProperty(f) || (b[f] = m.apply(null, k))
    }
    b = b ? b._modules : {};
    k(b, "modules/solid-gauge.src.js", [b["parts/Globals.js"], b["parts/Utilities.js"]], function(b, f) {
        var k =
            f.extend,
            m = f.isNumber,
            u = f.pick,
        ...
        f(b.Renderer.prototype.symbols, "arc", function(a, b, e, d, g, c) {
            a = a(b, e, d, g, c);
            c.rounded && (d = ((c.r || d) - c.innerR) / 2, c = ["A", d, d, 0, 1, 1, a[12], a[13]], a.splice.apply(a, [a.length - 1, 0].concat(["A", d, d, 0, 1, 1, a[1], a[2]])), a.splice.apply(a, [11, 3].concat(c)));
            return a
        });
        var w = {
            initDataClasses: function(a) {
                ...
                a.dataClasses.forEach(function(c, h) {
                    c = b.merge(c);
                    e.push(c);
                    c.color || ("category" === g.dataClassColor ? (h = t.options.colors,
                        c.color = h[d++], d === h.length && (d = 0)) : c.color = b.color(g.minColor).tweenTo(b.color(g.maxColor), h / (a.dataClasses.length - 1)))
                })
            },
        ...
        b.seriesType("solidgauge", "gauge", {
            ...
            drawPoints: function() {
                var a =
                    ...
                    f;
                m(d.threshold) && (f = b.startAngleRad + b.translate(d.threshold, null, null, null, !0));
                ...
                a.points.forEach(function(c) {
                    if (!c.isNull) {
                        var f = c.graphic,
                            ...
                            n = v(u(c.options.innerRadius, d.innerRadius, 60)) * e[2] / 200,
                            p = b.toColor(c.y, c),
                            q = Math.min(b.startAngleRad, b.endAngleRad),
                            m = Math.max(b.startAngleRad,
                                b.endAngleRad);
                        ...
                        f ? (r = n.d, f.animate(k({
                            fill: p
                        }, n)), r && (n.d = r)) : (c.graphic = f = g.arc(n).attr({
                            fill: p,
                            "sweep-flag": 0
                        }).add(a.group), a.chart.styledMode || ("square" !== d.linecap && f.attr({
